;; =====================================
;; Functions from no-rang org-mode
...
(defvar bh/organization-task-id "40c565e9-6e88-41fd-9243-092fe089dfe2")
              ...
              (let* ((daynr (string-to-int (format-time-string "%d" (current-time))))
                     ...
                     (subtree-is-current (save-excursion
                                           ...
                                           (and (< (point) subtree-end)
                                                (re-search-forward (concat last-week "\\|" this-week) subtree-end t)))))
